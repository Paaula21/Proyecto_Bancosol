<%--
Página JSP que muestra el panel de la edición de las campañas
Autores:
    ...
    <form id="form-campana" action="/campanas/guardar" method="POST">
        ...
        <div class="ficha-tarjeta-info sin-margen-inferior">
            ...
            <div class="checkbox-list"
                ...
                %>
                <label>
                    <input type="checkbox" name="cadenasIds" value="<%= cadena.getIdCadena() %>" <%= checked ? "checked" : "" %>>
                    <%= cadena.getNombreCadena() %>
                </label>
                <%  }
                } else { %>
                <p>No hay cadenas registradas en el sistema.</p>
                <% } %>
            </div>
        </div>
    </form>
